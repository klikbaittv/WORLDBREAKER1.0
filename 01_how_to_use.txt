...
================================================================
  ...
  04_latest_save.txt          Your most recent save, always up to date.
                               Load this to catch the AI up instantly.

  05_characters.txt           Your character registry.
                               Add characters by appending at the bottom.

  06_world_notes.txt          Your world: setting, history, atmosphere.
                               Append-only — the history stays intact.

  07_lexicon.txt              Your world's vocabulary.
                               Terms, places, slang, named things.

  08_story_arc.txt            Your plot. Acts, chapters, open threads.

  09_ledger.txt               Living canon document. NOT append-only.
...
YOU DO TWO THINGS:
  ...
  2. Replace 04_latest_save.txt with the second block the AI outputs.
...
APPEND-ONLY FILES (05 through 08):
...
================================================================
  ...
  Append-only   A file that only grows downward. Old entries stay.
                Never delete or edit above the last entry. (Files 05–08)

  Ledger        09_ledger.txt. Living canon document. Freely editable.
